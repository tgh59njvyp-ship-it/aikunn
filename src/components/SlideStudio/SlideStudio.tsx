...
export const SlideStudio: React.FC<SlideStudioProps> = ({
  ...
  const [mobileTab, setMobileTab] = useState<"slides" | "preview" | "edit">("preview");
    ...
    <div className="flex flex-col md:flex-row h-[calc(100vh-3.5rem)] sm:h-[calc(100vh-4rem)] bg-slate-950 overflow-hidden">
      ...
      <div className="flex md:hidden bg-slate-900 border-b border-slate-800 p-1.5 shrink-0 justify-around">
        <button
          ...
          className={`flex items-center space-x-1 px-3 py-1.5 rounded-lg text-xs font-medium transition ${
            mobileTab === "slides" ? "bg-purple-600 text-white" : "text-slate-400 hover:text-white"
          }`}
        >
        ...
        <button
          ...
          className={`flex items-center space-x-1 px-3 py-1.5 rounded-lg text-xs font-medium transition ${
            mobileTab === "preview" ? "bg-purple-600 text-white" : "text-slate-400 hover:text-white"
          }`}
        >
        ...
        <button
          ...
          className={`flex items-center space-x-1 px-3 py-1.5 rounded-lg text-xs font-medium transition ${
            mobileTab === "edit" ? "bg-purple-600 text-white" : "text-slate-400 hover:text-white"
          }`}
        >
      ...
      {isPresenting && (
        <div className="fixed inset-0 z-50 bg-black flex flex-col justify-between">
          ...
          <div className="h-14 bg-slate-900 border-t border-slate-800 px-4 sm:px-6 flex items-center justify-between text-white text-xs">
            ...
            <span className="text-slate-400 text-[11px] sm:text-xs truncate max-w-[200px] sm:max-w-none">
              ← → でスライド送り (Escで終了)
            </span>
          </div>
        </div>
      ...
      <div
        className={`w-full md:w-72 border-b md:border-b-0 md:border-r border-slate-800 bg-slate-900 flex flex-col shrink-0 ${
          mobileTab === "slides" ? "flex flex-1" : "hidden md:flex"
        }`}
      >
              ...
              >
                <div className="flex items-center justify-between mb-1.5 text-[10px] text-slate-400">
                  ...
                  <button
                    ...
                    className="opacity-80 md:opacity-0 group-hover:opacity-100 p-0.5 text-rose-400 hover:bg-rose-500/20 rounded"
                  >
      ...
      >
        ...
        <div className="h-12 border-b border-slate-800 bg-slate-900/60 px-3 sm:px-4 flex items-center justify-between shrink-0 gap-2">
          <div className="flex items-center space-x-1 sm:space-x-2 overflow-x-auto no-scrollbar">
            <span className="text-[11px] sm:text-xs font-semibold text-slate-300 whitespace-nowrap hidden sm:inline">テーマ:</span>
            <div className="flex items-center space-x-1">
              {[
                ...
                <button
                  ...
                  className={`px-2 py-0.5 sm:px-2.5 sm:py-1 rounded text-[11px] sm:text-xs transition whitespace-nowrap ${
          ...
          <button
            ...
            className="flex items-center space-x-1 sm:space-x-2 px-2.5 py-1 sm:px-4 sm:py-1.5 rounded-lg bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white text-[11px] sm:text-xs font-semibold shadow-md transition whitespace-nowrap shrink-0"
          >
        ...
        <div className="flex-1 overflow-y-auto p-2 sm:p-6 flex items-center justify-center bg-slate-950">
